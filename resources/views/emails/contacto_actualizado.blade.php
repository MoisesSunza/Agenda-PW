...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Se han guardado cambios en la información de tu contacto:</p>
            <div class="highlight">
                <strong>Contacto:</strong> {{ $contacto->nombre }}<br>
                <strong>Estado:</strong> Información actualizada y sincronizada.
            </div>
        </div>
        <div class="footer">
            Desarrollado por:
